      ...
      <Card className="space-y-4">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div>
            ...
            <Select id="type" name="type" required defaultValue="APARTMENT">
          ...
          <div>
            ...
            <Select id="ownership" name="ownership" required defaultValue="UNKNOWN">
              {OWNERSHIP.map((o) => (
        ...
        <div className="grid gap-4 border-t border-stone-200 pt-4 sm:grid-cols-3">
          ...
          {listingType === "RENT" && (
            <div>
              ...
              <Select id="rentPeriod" name="rentPeriod" defaultValue="MONTHLY">
